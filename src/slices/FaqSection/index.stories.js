...
const mock = {
  ...
  items: [
    {
      title: [{ type: 'heading3', text: 'Test tracking', spans: [] }],
      text: [
        {
          type: 'paragraph',
          text:
        ...
        },
        {
          type: 'paragraph',
          text:
            'If you use accordions to replace page steps such as checkout form steps, make sure you stop the default browser BACK button behavior so that the BACK button would move up a step in the accordion, because this is the behavior that most users expect, as tests show.',
          spans: [],
        },
      ],
    },
    {
      title: [{ type: 'heading3', text: "What's a headless CMS?", spans: [] }],
      text: [
        {
          type: 'paragraph',
          text:
    ...
    },
    {
      title: [
        {
          type: 'heading3',
          text: 'What so special about you?',
          spans: [],
        },
      ],
      text: [
        {
          type: 'paragraph',
          text:
            'The buttons need to specify which panels they control usingaria-controls, and they need to reflect the state of the panel (collapsed/expanded) usingaria-expanded="true/false". The panel itself also should havearia-hiddenset to true or false if it is hidden or shown, respectively.',
          spans: [],
        },
        {
          type: 'paragraph',
    ...
    {
      title: [{ type: 'heading3', text: 'Are you that different?', spans: [] }],
      text: [
        {
          type: 'paragraph',
          text:
  ...
  primary: {
    eyebrow_headline: [{ type: 'paragraph', text: 'FAQ', spans: [] }],
    title: [
      { type: 'heading1', text: 'Answers to common questions', spans: [] },
    ],
    description: [
      {
        type: 'paragraph',
